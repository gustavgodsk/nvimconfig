...
require("lazy").setup({
  ...
  -------------------------------------------------------
  -- NEW PLUGIN FOR GIT INTEGRATION
  -------------------------------------------------------
  {
    ...
    config = function()
      -- This just runs the default setup.
      require("gitsigns").setup()
    end,
  },

  -------------------------------------------------------
  -- NEW PLUGIN FOR AUTO PAIRS
  -------------------------------------------------------
  {
    "echasnovski/mini.pairs",
    event = "VeryLazy", -- This plugin only needs to load when you start typing
    config = function()
...
vim.api.nvim_create_autocmd("LspAttach", {
  ...
  callback = function(ev)
    ...
    -- It enables "format on save" for this LSP
